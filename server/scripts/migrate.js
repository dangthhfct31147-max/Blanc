...
const hallOfFameEntries = [
  {
    ...
    award: 'Champion',
    field: 'education',
    summary: 'Nền tảng kết nối mentor cựu học sinh với học sinh tỉnh lẻ để luyện thi và định hướng nghề nghiệp theo mô hình hybrid.',
    problem: 'Bài thi mở bằng khoảng cách tiếp cận mentor giữa học sinh thành phố và học sinh tỉnh, sau đó chốt lại bằng một câu chuyện người dùng rất cụ thể.',
    solution: 'Deck dẫn thẳng vào giải pháp gồm matching mentor, lộ trình học theo mục tiêu và phiên cố vấn ngắn hàng tuần để giảm rào cản bắt đầu.',
    impact: 'Nhóm trình bày 320 học sinh tham gia pilot, tỷ lệ quay lại 61% sau 6 tuần và 24 mentor duy trì hoạt động tự nguyện.',
    whyItWon: 'Bài thi mạnh ở chỗ nhịp trình bày rất gọn: nêu pain point, chứng minh nhu cầu, demo luồng sản phẩm rồi mới nói đến mở rộng và nguồn lực cần thiết.',
    ...
    resources: [
      {
        ...
        format: 'Web preview',
        description: 'One-page overview của bài thi gồm vấn đề, giải pháp, số liệu pilot và roadmap.',
      },
      {
        id: 'edubridge-slides',
        type: 'slides',
        ...
        description: 'Từng phần slide được ghi chú rõ vai trò: hook, problem, solution, traction, ask.',
      },
      {
        id: 'edubridge-video',
        type: 'video',
        ...
        format: 'Pitch notes',
        description: 'Bản mô phỏng flow nói 3 phút, nhấn chỗ nào cần dừng để chốt luận điểm.',
      },
    ],
    structure: [
      { id: 'edubridge-s1', order: 1, label: 'Slide 1', title: 'Hook bằng 1 con số', description: 'Mở bằng chênh lệch cơ hội tiếp cận mentor giữa học sinh thành phố và tỉnh.', objective: 'Kéo ban giám khảo vào pain point ngay lập tức.' },
      { id: 'edubridge-s2', order: 2, label: 'Slide 2', title: 'User story', description: 'Dùng chân dung một học sinh cụ thể để nhân hóa vấn đề.', objective: 'Biến dữ liệu thành câu chuyện dễ nhớ.' },
      { id: 'edubridge-s3', order: 3, label: 'Slide 3', title: 'Problem landscape', description: 'Tóm tắt 3 nhóm khó khăn: thiếu mentor, thiếu lộ trình, thiếu theo dõi tiến độ.', objective: 'Cho thấy đây là bài toán hệ thống chứ không phải nhu cầu đơn lẻ.' },
      { id: 'edubridge-s4', order: 4, label: 'Slide 4', title: 'Solution snapshot', description: 'Một màn hình mô tả mentor matching, lộ trình học và lịch cố vấn ngắn.', objective: 'Chứng minh giải pháp gọn và dễ hiểu.' },
      { id: 'edubridge-s5', order: 5, label: 'Slide 5', title: 'Pilot & traction', description: 'Đưa số liệu dùng thử, tỷ lệ quay lại và feedback nổi bật.', objective: 'Chứng minh giải pháp đã được kiểm chứng.' },
      { id: 'edubridge-s6', order: 6, label: 'Slide 6', title: 'Roadmap & ask', description: 'Nêu mốc mở rộng, nguồn lực cần và tác động nếu được hỗ trợ.', objective: 'Kết thúc bằng đề xuất cụ thể, không lan man.' },
    ],
    takeaways: [
      'Nếu mở bằng số liệu, hãy nối ngay sang một câu chuyện người dùng để tránh deck bị khô.',
      'Traction chỉ nên đưa 2-3 chỉ số mạnh nhất, đừng làm giám khảo phải đọc quá nhiều.',
      'Phần ask ở cuối cần bám trực tiếp vào roadmap, không nên xuất hiện rời rạc.',
    ],
  },
  {
    ...
    award: 'First Prize',
    field: 'cyber',
    summary: 'Bộ công cụ huấn luyện nhận diện phishing cho học sinh và giáo viên bằng các kịch bản giả lập ngắn, có dashboard theo dõi rủi ro.',
    problem: 'Nhóm dùng 3 ví dụ email lừa đảo rất đời thường để chỉ ra vì sao học sinh vẫn nhấp link dù đã được nhắc về an toàn số.',
    solution: 'Giải pháp kết hợp phishing simulation, bài học siêu ngắn sau mỗi lần sai và dashboard để giáo viên thấy rủi ro theo lớp.',
    impact: 'Pilot tại 4 lớp học cho thấy tỷ lệ nhấp email giả giảm từ 41% xuống còn 13% sau 3 tuần.',
    whyItWon: 'Bài thi nổi bật nhờ demo gọn và cách chuyển từ demo sang impact rất mượt, khiến giám khảo thấy ngay giá trị giáo dục lẫn khả năng triển khai.',
    ...
    resources: [
      {
        ...
        format: 'Web preview',
        description: 'Tóm tắt mục tiêu học tập, cơ chế mô phỏng và KPI mà nhóm dùng khi pilot.',
      },
      {
        id: 'shieldup-slides',
        type: 'slides',
        ...
        format: 'Annotated deck',
        description: 'Bóc tách từng slide để thấy cách nhóm chuyển từ threat demo sang business value.',
      },
      {
        id: 'shieldup-video',
        type: 'video',
        ...
        format: 'Pitch notes',
        description: 'Khung nói 180 giây với cue để nhấn insight hành vi người dùng.',
      },
    ],
    structure: [
      { id: 'shieldup-s1', order: 1, label: 'Slide 1', title: 'Cold open bằng email giả', description: 'Mở bằng ảnh chụp email phishing rất giống email trường học.', objective: 'Tạo cảm giác cấp bách và gần gũi.' },
      { id: 'shieldup-s2', order: 2, label: 'Slide 2', title: 'Phân tích nguyên nhân', description: 'Nhóm chỉ ra học sinh sai vì áp lực tốc độ và thiếu phản xạ nhận diện dấu hiệu nguy hiểm.', objective: 'Không chỉ nêu triệu chứng mà còn giải thích hành vi.' },
      { id: 'shieldup-s3', order: 3, label: 'Slide 3', title: 'Product loop', description: 'Mô tả chu trình simulate → phản hồi ngay → dashboard → ôn tập.', objective: 'Cho thấy giải pháp có logic huấn luyện rõ ràng.' },
      { id: 'shieldup-s4', order: 4, label: 'Slide 4', title: 'Live demo', description: 'Demo một email giả và màn hình phản hồi sau khi học sinh bấm nhầm.', objective: 'Biến giải pháp thành thứ nhìn thấy được.' },
      { id: 'shieldup-s5', order: 5, label: 'Slide 5', title: 'Pilot result', description: 'So sánh tỷ lệ nhấp trước và sau khi dùng hệ thống.', objective: 'Chốt hiệu quả bằng một biểu đồ duy nhất.' },
      { id: 'shieldup-s6', order: 6, label: 'Slide 6', title: 'Deployment plan', description: 'Nêu rõ cách triển khai theo trường, lớp và vai trò giáo viên.', objective: 'Làm rõ tính khả thi sau cuộc thi.' },
    ],
    takeaways: [
      'Với đề tài an toàn số, demo thực tế quan trọng hơn mô tả dài dòng.',
      'Một biểu đồ before/after mạnh thường hiệu quả hơn ba biểu đồ rải rác.',
      'Nếu sản phẩm có dashboard, hãy nói rõ ai dùng dashboard đó và quyết định gì từ nó.',
    ],
  },
  {
    ...
    award: 'Runner-up',
    field: 'startup',
    summary: 'Mô hình giúp căng tin trường học giảm bao bì dùng một lần bằng hệ thống đặt món trước và hộp hoàn trả có thưởng.',
    problem: 'Deck mô tả rất rõ lượng rác phát sinh trong giờ nghỉ trưa và chi phí mà căng tin phải gánh khi thay đổi bao bì không có hệ thống hỗ trợ.',
    solution: 'Giải pháp ghép app đặt món trước, QR cho hộp dùng lại và cơ chế hoàn điểm để duy trì thói quen trả hộp.',
    impact: 'Nhóm chạy thử tại hai căng tin, giảm 38% hộp dùng một lần trong 4 tuần và giữ được 72% người dùng quay lại tuần thứ tư.',
    whyItWon: 'Bài thi được đánh giá cao vì cấu trúc vừa có số liệu môi trường vừa có logic vận hành và incentive rõ ràng cho người dùng lẫn đơn vị bán hàng.',
    ...
    resources: [
      {
        ...
        format: 'Web preview',
        description: 'One-page mô tả luồng vận hành, incentive và chỉ số giảm rác.',
      },
      {
        id: 'greencart-slides',
        type: 'slides',
        ...
        format: 'Annotated deck',
        description: 'Đánh dấu những slide nào nói về pain point, solution, incentive và unit economics.',
      },
    ],
    structure: [
      { id: 'greencart-s1', order: 1, label: 'Slide 1', title: 'Waste snapshot', description: 'Mở bằng lượng rác trong một giờ nghỉ trưa tại trường.', objective: 'Đặt bài toán môi trường bằng hình ảnh và số liệu ngay từ đầu.' },
      { id: 'greencart-s2', order: 2, label: 'Slide 2', title: 'Stakeholder pain', description: 'Tách pain point của học sinh, căng tin và nhà trường thành ba cột rất rõ.', objective: 'Chứng minh nhiều bên cùng có lợi khi giải bài toán này.' },
      { id: 'greencart-s3', order: 3, label: 'Slide 3', title: 'How the loop works', description: 'Giải thích vòng lặp đặt món, nhận hộp, trả hộp, nhận thưởng.', objective: 'Làm rõ giải pháp không chỉ là app mà là hành vi có incentive.' },
      { id: 'greencart-s4', order: 4, label: 'Slide 4', title: 'Economics', description: 'Nhóm đưa chi phí hộp, tỷ lệ mất hộp và điểm hòa vốn rất ngắn gọn.', objective: 'Trả lời sớm câu hỏi về tính bền vững tài chính.' },
      { id: 'greencart-s5', order: 5, label: 'Slide 5', title: 'Pilot result', description: 'Đưa số hộp dùng một lần giảm được và tỷ lệ quay lại của người dùng.', objective: 'Chứng minh thay đổi hành vi có thể đo được.' },
      { id: 'greencart-s6', order: 6, label: 'Slide 6', title: 'Expansion path', description: 'Kết bằng kế hoạch nhân rộng sang cụm trường và đối tác vận hành.', objective: 'Cho giám khảo thấy dư địa scale up.' },
    ],
    takeaways: [
      'Nếu giải pháp có nhiều stakeholder, nên tách pain point theo từng nhóm để giám khảo theo dõi nhanh.',
      'Slide economics không cần dài, chỉ cần trả lời rõ câu hỏi “ai trả tiền và vì sao đáng”.',
      'Với đề tài bền vững, đừng quên gắn số liệu môi trường với hành vi người dùng thực tế.',
    ],
  },
];

function buildHallOfFameSearchText(entry) {
  return [
    entry.title,
    entry.teamName,
    entry.contestName,
