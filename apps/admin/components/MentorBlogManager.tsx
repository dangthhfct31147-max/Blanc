          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-2xl">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">Blog body</label>
                  <textarea
                    value={form.body}
                ...
                <div className="flex justify-end gap-2">
                  <button type="button" onClick={closeModal} className="rounded-lg px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100">
                    Cancel
                  </button>
                  <button
                    type="submit"
                ...
                items.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-xs text-gray-500">{formatDate(updatedAt)}</td>
