...
const RecruitmentManager: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const contact = Object.fromEntries(Object.entries(form.contact).filter(([, value]) => Boolean(String(value || '').trim())));
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-gray-500">Create and manage recruitment posts</p>
        </div>
                  ...
                  <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div className="space-y-1">
                        ...
                        <p className="line-clamp-1 text-xs text-gray-500">{item.summary || '-'}</p>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span
            ...
            <>
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 font-mono text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500"
                    rows={10}
                ...
                {form.roles.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {form.roles.map((r, idx) => (
                      <div key={idx} className="space-y-3 rounded-xl border border-gray-200 bg-gray-50 p-4">
                        <div className="flex items-center justify-between gap-2">
                        ...
                        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500"
                              disabled={isReadOnly}
                            />
                          </div>
                          <div>
                            <label className="mb-1 block text-xs font-medium text-gray-600">Skills</label>
                            <input
                              value={r.skills}
                              onChange={(e) =>
                                setForm((prev) => ({
              ...
              <div className="space-y-3 border-t border-gray-100 pt-4">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-1 block text-xs font-medium text-gray-600">Discord</label>
                    <input
